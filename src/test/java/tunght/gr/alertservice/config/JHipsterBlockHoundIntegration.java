...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("tunght.gr.alertservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("tunght.gr.alertservice.security.DomainUserDetailsService", "createSpringSecurityUser");
